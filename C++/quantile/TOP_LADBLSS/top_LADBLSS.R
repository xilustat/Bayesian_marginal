...
setwd("/Users/xilu/Desktop/C++/quantile/TOP_LADBLSS")
...
{  
  ...
  for(j in 1:p)
  {
    ...
    theta=0.5; r1=1; r=1; a=1; b=1; sg1=1; sg2 = rep(1,q2)
    hatPiBeta=1/2; hatPiEta=1/2
    sh0=1; sh1=1
    progress = 0
    betas = RBLSSVC(x,y,w,c,e,max.steps,n,hatAlpha,hatb,hatBeta,hatEta,hatTau,hatV,hatSg1,hatSg2,sg1,sg2,invSigAlpha0, invSigb0, hatEtaSq1, hatEtaSq2, theta, r1, r,a ,b ,hatPiBeta,hatPiEta,sh0,sh1, progress)
    t12 = betas$GS.beta
