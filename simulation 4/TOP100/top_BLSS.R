...
mean1 = mean(total_TP_main); s1 = sd(total_TP_main); mean2 = mean(total_TP_inter); s2 = sd(total_TP_inter);
mean3 = mean(total_TP_main+total_TP_inter); s3 = sd(total_TP_main+total_TP_inter)

save(total_TP_main, total_TP_inter,mean1,s1,mean2,s2,mean3,s3,m1,m3, file = "top_BLSS.RData")  
