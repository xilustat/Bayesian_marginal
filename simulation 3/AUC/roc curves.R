...
fpr3=fpr_LADBL; tpr3=tpr_LADBL; auc3=auc_LADBL

fpr_LADBL=rbind(fpr1,fpr2,fpr3)
tpr_LADBL=rbind(tpr1,tpr2,tpr3)
auc_LADBL=c(auc1,auc2,auc3)
...
fpr_LADBLSS=rbind(fpr1,fpr2,fpr3)
tpr_LADBLSS=rbind(tpr1,tpr2,tpr3)
auc_LADBLSS=c(auc1,auc2,auc3)
