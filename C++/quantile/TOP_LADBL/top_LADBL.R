...
{  
  ...
  for (k in 1:length(prob_seq)) 
  {
    ...
    for(j in 1:p)
    {
      ...
      theta=0.5; r1=1; r=1; a=1; b=1
      progress = 0
      betas = RBLVC(x,y,w,c,e,max.steps,n,hatAlpha,hatb,hatBeta,hatEta,hatTau,hatV,hatSg1,hatSg2,invSigAlpha0, invSigb0, hatEtaSq1, hatEtaSq2, theta, r1, r,a ,b, progress)
