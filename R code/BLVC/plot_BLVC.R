...
betas1 <- BLVC(e,c,x, w, y, max.steps) 
betas2 <- BLVC(e,c,x, w, y, max.steps) 
betas3 <- BLVC(e,c,x, w, y, max.steps) 
betas4 <- BLVC(e,c,x, w, y, max.steps) 
betas5 <- BLVC(e,c,x, w, y, max.steps) 
...
temp = gelman.plot(xx,ylab = TeX('$\\beta$'),xlab = "BL", ylim=c(1,1.5))
temp
...
sum(abs(t1)+abs(t2)+abs(t3)+abs(t4)+abs(t5))
gelman.diag(xx)
temp=gelman.plot(xx,ylab = TeX('$\\eta^{2}$'),xlab = "BL", ylim=c(1,1.5))
temp
...
sum(abs(t1)+abs(t2)+abs(t3)+abs(t4)+abs(t5))
gelman.diag(xx)
temp=gelman.plot(xx,ylab = TeX('$\\sigma^{2}$'),xlab = "BL", ylim=c(1,1.5))
temp
...
sum(abs(t1)+abs(t2)+abs(t3)+abs(t4)+abs(t5))
gelman.diag(xx)
temp=gelman.plot(xx,ylab = TeX('$\\lambda_c^{2}$'),xlab = "BL")
temp
...
sum(abs(t1)+abs(t2)+abs(t3)+abs(t4)+abs(t5))
gelman.diag(xx)
temp=gelman.plot(xx,ylab = TeX('$\\lambda_e^{2}$'),xlab = "BL")
temp
...
sum(abs(t1)+abs(t2)+abs(t3)+abs(t4)+abs(t5))
gelman.diag(xx)
temp=gelman.plot(xx,ylab = TeX('$\\1/tau_e^{2}$'),xlab = "BL-SS")
temp
...
for(i in 1:4){
  ...
  sum(abs(t1)+abs(t2)+abs(t3)+abs(t4)+abs(t5))
  gelman.diag(xx)
  gelman.plot(xx,main=paste("The",d,"th"),ylab = TeX('$\\eta^{2}$'),xlab = "BL", ylim=c(1,1.5))
  temp = gelman.plot(xx,main=paste("The",d,"th"),ylab = TeX('$\\eta^{2}$'),xlab = "BL", ylim=c(1,1.5))
  temp
