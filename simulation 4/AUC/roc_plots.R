...
setwd("/Users/xilu/Desktop/marginal_bayes/simulation/simulation 4/AUC/data2")
...
setwd("/Users/xilu/Desktop/marginal_bayes/simulation/simulation 4/AUC/data3")
load("roc_BL.RData"); load("roc_BLSS.RData"); load("roc_LADBL.RData"); load("roc_LADBLSS.RData"); 
...
setwd("/Users/xilu/Desktop/marginal_bayes/simulation/simulation 4/AUC/data4")
load("roc_BL.RData"); load("roc_BLSS.RData"); load("roc_LADBL.RData"); load("roc_LADBLSS.RData"); 
...
setwd("/Users/xilu/Desktop/marginal_bayes/simulation/simulation 4/AUC/data5")
load("roc_BL.RData"); load("roc_BLSS.RData"); load("roc_LADBL.RData"); load("roc_LADBLSS.RData"); 
